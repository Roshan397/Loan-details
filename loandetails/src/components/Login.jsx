...
export default function Login() {
  ...
  const onSubmit = async (e) => {
    e.preventDefault();
    const r=await axios.post("http://localhost:8080/user/login", user);
  ...
  return (
    ...
    <div className="cover">
        ...
        style={{width:"300px"}}/>
        <div className="login">
        <button type="submit" className="login-btn" style={{backgroundColor:" #9D1D27",color:"white",paddingTop:"12px",fontSize:"large"}}>Login</button>
        </div >
        <p>or</p>
        <div>
