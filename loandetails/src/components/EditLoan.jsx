...
export default function EditLoan() {
  ...
  const [user, setUser] = useState( {
    ...
    const { loanid,loantype,applicantname,applicantaddress,applicantmobile,applicantemail,applicantaadhaar,applicantpan,applicantsalary,loanamountrequired,loanrepaymentmonths } = user;
...
return (
  <div>
      ...
      <div className="cover2">
          <h1 >Update Loan</h1>
          <TextField fullwidth label="loan-id" placeholder="Enter loanid" name="loanid"
          value={loanid}
